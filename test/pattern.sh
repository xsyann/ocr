...
##
## Started on  Fri Apr 11 13:19:53 2014 xs_yann
## Last update Fri Apr 11 13:27:20 2014 xs_yann
##
...
#for k, v in sorted(folder.iteritems()):
#  print "elif [ $name = '{0}' ]; then name='{1}';".format(os.path.basename(v), k)

if [ $name = 'sym_space' ]; then name=' ';
elif [ $name = 'sym_exclmark' ]; then name='!';
